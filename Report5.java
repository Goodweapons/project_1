...
public class Report5 extends JFrame implements Printable, ActionListener{
     ...
     public Report5(/*Connection con*/){
          ...
          headerStr="SHIPMENT DETAILS";
          this.setSize(750,500);
          titleStr="LIST OF TOTAL SOLD ITEM";
          ...
          try
          {
               ...
               String booktblheading[ ]={"ORDER ID","CUSTOMER NAME","ADDRESS","ITEM NAME","TOTAL QUANTITY","DATE","TOTAL SOLD ITEM"};
