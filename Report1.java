...
public class Report1 extends JFrame implements Printable, ActionListener{
     ...
     public Report1(/*Connection con*/){
          ...
          headerStr="ADMIN DETAILS";
          this.setSize(750,500);
          titleStr="LIST OF ADMIN";
          ...
          try
          {
               ...
               String booktblheading[]={"ADMIN NAME","ADMIN ID","ADDRESS","EMAIL ID"};
