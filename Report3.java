...
public class Report3 extends JFrame implements Printable, ActionListener{
     ...
     public Report3(/*Connection con*/){
          ...
          headerStr="INVENTORY DETAILS";
          this.setSize(750,500);
          titleStr="LIST OF INVENTORY WITH QUANTITY DETAILS";
          ...
          try
          {
               ...
               ResultSet rs=st.executeQuery("select invntry_type,invntry_id,Item_name,quantity,cost_price,selling_price,profit_loss,totalcost,t_q  from Inventory");
               ResultSetMetaData md= rs.getMetaData();
               int columns =md.getColumnCount();
               String booktblheading[ ]={"INVENTORY TYPE","INVENTORY ID","ITEM NAME","QUANTITY","COST PRICE","SELLING PRICE","PROFIT / LOSS","TOTAL_COST","TOTAL QUANTITY"};
